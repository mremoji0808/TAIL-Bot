<img width="150" height="150" align="left" style="float: left; margin: 0 10px 0 0;" alt="TAIL" src="https://i.imgur.com/3Og2ThY.png">  
...
| `hoasked` | Show whoasked playlist. |
...
| `lock` | Lock a channel. |
| `unlock` | Unlock a previously lock channel.|
